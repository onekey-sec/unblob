...
@pytest.mark.parametrize(
    ...
    (
        ...
        (b"\x00\x00\x00\x00\x00\x00\x00\x00\x00", -1),
        (b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", -1),
        (
...
def test_romfs_checksum(content, expected):
    assert romfs_checksum(content) == expected
