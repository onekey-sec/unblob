...
@pytest.mark.parametrize(
    ...
    [
        (TemporaryFileDeletionMode.NONE, (), True),
        (TemporaryFileDeletionMode.SOME, ("gzip",), True),
        (TemporaryFileDeletionMode.SOME, ("tar",), False),
        (TemporaryFileDeletionMode.ALL, (), False),
    ],
)
def test_temporary_file_cleanup(
    deletion_mode: TemporaryFileDeletionMode,
    ...
    extraction_config.temporary_file_deletion = deletion_mode
    extraction_config.temporary_file_handler_filter = handler_filter
